...
param paypalClientId = readEnvironmentVariable('PROMETHEUS_PAYPAL_CLIENT_ID', '')
param paypalClientSecret = readEnvironmentVariable('PROMETHEUS_PAYPAL_CLIENT_SECRET', '')
param paypalApiBase = readEnvironmentVariable('PROMETHEUS_PAYPAL_API_BASE', 'https://api-m.paypal.com')
param paypalWebhookId = readEnvironmentVariable('PROMETHEUS_PAYPAL_WEBHOOK_ID', '')
